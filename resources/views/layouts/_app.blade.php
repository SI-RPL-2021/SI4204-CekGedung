        ...
        <aside class="left-sidebar">
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="{{ route('index') }}" aria-expanded="false"><i class="icon-File-Hide"></i><span class="hide-menu">Starter page </span></a></li>
